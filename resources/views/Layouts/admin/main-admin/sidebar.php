<?php
$base_url_style = "/../../../../resources/assets/css/admin/";
$base_url_script = "/../../../../resources/assets/js/admin/";
include_once __DIR__ . "\..\header.php";
include __DIR__ . "\..\..\..\..\..\app\middleware\admin\main-admin\auth.php";
?>
...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <div class="block" x-data="{open: false}">
                    ...
                    <div x-show="open"
                        ...
                        <div class="block" x-data="{open: false}">
                            ...
                            <div x-show="open"
                                class="text-sm border-l-2 border-gray-800 ml-6 my-2.5 pl-2.5 flex flex-col gap-y-1">
                                <a href="<?= isset($base_url_link) ? $base_url_link : "" ?>add/add-category.php" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Add
                                </a>
        ...
        <!-- Logout -->
        <div class="px-6 my-6">
            <a href="<?= $base_url_logout ?>Logout.php"
                class="flex items-center w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple hover:text-red-500">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
