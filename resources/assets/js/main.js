...
*/
// Check if the password reset form is already displayed from a previous session
window.addEventListener('DOMContentLoaded', function() {
    var isResetPasswordFormDisplayed = sessionStorage.getItem('isResetPasswordFormDisplayed');
    if (isResetPasswordFormDisplayed === 'true') {
        document.getElementById('recover_password').style.display = 'block';
        document.getElementById('login').style.display = 'none';
    }
});

// Function to display the password reset form and save the state to sessionStorage
function showRecoverPasswordForm() {
    document.getElementById('recover_password').style.display = 'block';
    document.getElementById('login').style.display = 'none';
    sessionStorage.setItem('isResetPasswordFormDisplayed', 'true');
}

// Function to hide the password reset form and remove the state from sessionStorage
function hideRecoverPasswordForm() {
    document.getElementById('recover_password').style.display = 'none';
    document.getElementById('login').style.display = 'block';
    sessionStorage.removeItem('isResetPasswordFormDisplayed');
}
...
const inputs = ["input1", "input2", "input3", "input4", "input5"];
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var sidebarLinks = document.querySelectorAll('.under-line-nav');
